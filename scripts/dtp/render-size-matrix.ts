...
async function cases(): Promise<{ h: number; ad: DtpAdvertisement; extra: Record<string, unknown> }[]> {
  return [
    ...
    { h:11, ad: { headline:"Jobs in Saudi Arabia – 100% client interview",
        tenant:{name:"Silverline HR Consultants", registrationText:"B-1487/MUM/PART/1000+/9986/2022", logo: dtpTenantLogo(await logo(BLACK, 360, 150))},
        campaigns:[
          { heading:"Hiring for Masco – Amiral – Oil & Gas Project", interview:"Mumbai on 26th March",
            positions:[
              {title:"Foreman",qualifier:"Civil / Electrical / Mechanical"},
              {title:"Leadman",qualifier:"Civil / Electrical / Mechanical"},
              {title:"WPR",qualifier:"Aramco approved"},
              {title:"Operator",qualifier:"Mobile Crane 55T, Saudi licence"},
              {title:"Carpenter / Mason / Plumber"},
              {title:"Store Helper / Time Keeper"},
          ...
          { heading:"Hiring for Exact (Al Rashid Group)", interview:"Mumbai 28th · Vadodara 27th · Vizag 30th March",
            positions:[
              {title:"Pipe Welder",qualifier:"6G Multi-TIG & ARC"},
              {title:"Pipe Fabricator / Fitter"},
              {title:"Rigger Level 3"},
            ],
            note:"Must have GCC experience in the relevant industry.",
            contactPhone:"8655440318" },
          { heading:"Hiring for Saudi Korean Joint Venture / EPC", interview:"Mumbai on 30th March",
            positions:[
              {title:"Multi Welder CS & SS",qualifier:"TIG & ARC both"},
              {title:"Multi Welder CS",qualifier:"TIG & ARC"},
              {title:"Pipe Fabricator / Fitter"},
            ],
            note:"Must have experience in Oil & Gas projects in GCC / Saudi.",
            contactPhone:"8655960413" },
        ],
        contactPhone:"8655440316", contactEmail:"jobs@example-agency.test", accent:BLACK },
      extra:{ interviewVenue:"Venue for all above: SAFCO Trade Test, Gami Industrial Park", established:"Estd. 1984",
        addressLines:["C-39A, Gami Industrial Park, 1st Floor,","Gala 23, Pawne KATA, Turbhe,","Navi Mumbai. Direct bus from Sanpada St."] } },
