...
/** POST /api/agency-verifications/[agencyId]/suspend — KAI Super Admin only. */
export async function POST(
  ...
  try {
    ...
    const verification = await agencyVerificationService.setStatus(agencyId, user.id, "SUSPENDED", input.notes);
